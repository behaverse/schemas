...
| **trial** | `schema.linkml.yaml` | `scripts/generate.py` | `schema.json`, `context.jsonld`, `field-definitions.json` (multi-table render artifact) |
...
| **studyflow** | `schema.linkml.yaml` | `scripts/generate.py` | `schema.json`, `field-definitions.json` |
...
> Overview now reads it (and the generated `field-definitions.json`) directly.
