...
| `@type` | string | no | Fixed value `csvw:Table` — the JSON-LD node type (`rdf:type`) |
...
| `description` | string | yes | Detailed description of the table contents |
...
```
https://behaverse.org/schemas/bcsv/versions/v26.0608/schema.json
```
