...
- Prose sweep of the published strings: 18 descriptions gained their terminal period (descriptions are sentences; fragments belong in `range`). No semantic changes.
